...
public class Search {
	...
	public static void main(String[] args) 
			throws IOException{				//Files.walkFileTree doesn't work with the throw
	{
	...
	public static class Finder extends SimpleFileVisitor<Path>
	{
		...
		private static final FileVisitResult CONTINUE = null;			//constant variable from SimpleVisitResult
